...
* mc-kaishixiaxue: Updated chinese translation.
* RhenanAC & PrincessStellar: Updated Brazilian translation.
* Fixed an issue where the gem cutting table thought air could be upgraded.
* Fixed rarity resolution for affix loot entries generated by the primary affix loot injector.
* Added a guard against the Telepathic affix sending items to (0,0,0).
...
* Added the Gem of the Verdant Ruin, a new Overworld-exclusive gem.
