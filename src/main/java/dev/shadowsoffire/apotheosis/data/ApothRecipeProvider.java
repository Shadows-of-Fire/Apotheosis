...
public class ApothRecipeProvider extends LegacyRecipeProvider {
    ...
    protected void genRecipes(RecipeOutput out, HolderLookup.Provider registries) {
        ...
        addShaped(Blocks.BASIC_GEM_CASE, 3, 3, Tags.Items.GLASS_BLOCKS, Tags.Items.GLASS_BLOCKS, Tags.Items.GLASS_BLOCKS, Items.BASALT, Items.GEM_CUTTING_TABLE, Items.BASALT, Items.BASALT, Items.ENDER_CHEST, Items.BASALT);
