...
public class SupremacyRecipe extends ApothSmithingRecipe implements ReactiveSmithingRecipe {
    ...
    public SupremacyRecipe() {
        super(BASE_PLACEHOLDER, Ingredient.of(Items.SIGIL_OF_SUPREMACY.value()), ItemStack.EMPTY);
    }
    ...
    public RecipeSerializer<? extends net.minecraft.world.item.crafting.SmithingRecipe> getSerializer() {
        return (RecipeSerializer<? extends net.minecraft.world.item.crafting.SmithingRecipe>) Apoth.RecipeSerializers.SUPREMACY.value();
    }
