...
public class SocketCommand {
    ...
    public static void register(LiteralArgumentBuilder<CommandSourceStack> root) {
        root.then(Commands.literal("set_sockets").requires(Commands.hasPermission(Commands.LEVEL_GAMEMASTERS)).then(Commands.argument("sockets", IntegerArgumentType.integer(0, 16)).executes(c -> {
