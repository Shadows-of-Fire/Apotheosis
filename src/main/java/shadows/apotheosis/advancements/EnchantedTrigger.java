...
public class EnchantedTrigger extends EnchantedItemTrigger {
	...
	public Instance createInstance(JsonObject json, EntityPredicate.AndPredicate entityPredicate, ConditionArrayParser conditionsParser) {
		...
		FloatBound rectification = FloatBound.fromJson(json.get("rectification"));
		Instance inst = new Instance(item, levels, eterna, quanta, arcana, rectification);
		return inst;
	}

	public void trigger(ServerPlayerEntity player, ItemStack stack, int level, float eterna, float quanta, float arcana, float rectification) {
	...
	public static class Instance extends EnchantedItemTrigger.Instance {
		...
		protected final FloatBound eterna, quanta, arcana, rectification;

		public Instance(ItemPredicate item, IntBound levels, FloatBound eterna, FloatBound quanta, FloatBound arcana, FloatBound rectification) {
