...
public class DeadlyConstants {
	...
	public static final String[] BRUTAL_DEFAULT_MOBS = { "4@minecraft:zombie", "1@minecraft:skeleton", "1@minecraft:spider", "1@minecraft:cave_spider", "1@minecraft:creeper", "1@apotheosis:random" };
