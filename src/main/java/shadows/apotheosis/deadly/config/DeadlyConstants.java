...
public class DeadlyConstants {
	...
	public static final String[] BRUTAL_DEFAULT_MOBS = { "3@minecraft:zombie", "3@minecraft:skeleton", "2@minecraft:husk", "2@minecraft:stray", "1@minecraft:spider" };
	public static final ResourceLocation RANDOM = new ResourceLocation(Apotheosis.MODID, "random");
	public static final String[] BOSS_DEFAULT_MOBS = { "3@minecraft:zombie", "3@minecraft:skeleton", "2@minecraft:husk", "2@minecraft:stray", "1@minecraft:wither_skeleton", "1@minecraft:pillager" };
