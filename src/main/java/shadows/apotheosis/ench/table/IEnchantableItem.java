...
public interface IEnchantableItem {
	 ...
	 */
	default ItemStack onEnchantment(ItemStack stack, List<EnchantmentData> enchantments) {
	 ...
	 */
	default List<EnchantmentData> selectEnchantments(List<EnchantmentData> builtList, Random rand, ItemStack stack, int level, float quanta, float arcana, boolean treasure) {
		return builtList;
	}
	...
	default boolean forciblyAllowsTableEnchantment(ItemStack stack, Enchantment enchantment) {
		return stack.getItem() == Items.BOOK && enchantment.isAllowedOnBooks();
	}
