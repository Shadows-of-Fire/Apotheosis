...
public class EnderLeashItem extends Item {
	...
	public void appendHoverText(ItemStack stack, Level worldIn, List<Component> tooltip, TooltipFlag flagIn) {
		if (stack.hasTag()) {
			...
			if (tag.isEmpty()) tooltip.add(new TranslatableComponent("info.apotheosis.noentity"));
			else {
				tooltip.add(new TranslatableComponent("info.apotheosis.containedentity", stack.getTag().getString("name")));
			}
		}
	}
