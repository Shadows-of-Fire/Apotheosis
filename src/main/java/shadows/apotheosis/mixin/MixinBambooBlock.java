...
public class MixinBambooBlock {
	...
	private int modifyMaxBambooHeight(int maxHeightIn) {
	...
	private int modifyMaxBambooHeightGrow(int maxHeightIn) {
	...
	private int modifyBambooSlowdownHeightThreshold(int slowdownThresholdIn) {
