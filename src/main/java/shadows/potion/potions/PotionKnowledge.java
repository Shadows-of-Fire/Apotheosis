...
public class PotionKnowledge extends Potion {
	...
	public PotionKnowledge() {
		...
		setPotionName("effect." + Apotheosis.MODID + ".knowledge");
		setBeneficial();
	}
	...
	public void renderInventoryEffect(int x, int y, PotionEffect effect, Minecraft mc) {
		...
		Gui.drawModalRectWithCustomSizedTexture(x + 7, y + 7, 0, 16, 16, 16, 128, 128);
	}
	...
	public void renderHUDEffect(int x, int y, PotionEffect effect, Minecraft mc, float alpha) {
		mc.renderEngine.bindTexture(PotionModule.POTION_TEX);
		Gui.drawModalRectWithCustomSizedTexture(x + 4, y + 4, 0, 16, 16, 16, 128, 128);
	}
