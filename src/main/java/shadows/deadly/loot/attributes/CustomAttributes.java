...
public class CustomAttributes {
	...
	public static final IAttribute COLD_DAMAGE = new ElementalDmgAttribute("apoth.colddmg", (e, l) -> {
		...
		e.attackEntityFrom(COLD, !e.world.isDaytime() ? l : 2 * l);
	});
}
