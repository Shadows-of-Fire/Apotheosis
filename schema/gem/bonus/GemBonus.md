...
8. [Anti-Gravity Arrow Bonus](./AntiGravityArrowBonus.md) - Removes gravity from fired arrows.
9. [Leech Block Bonus](./LeechBlockBonus.md) - Heals the user when blocking damage.
10. [All Stats Bonus](./AllStatsBonus.md) - Applies the same modifier to a list of attributes.
11. [Drop Transform Bonus](./DropTransformBonus.md) - Randomly converts certain drops into another item.
12. [Mage Slayer Bonus](./MageSlayerBonus.md) - Converts a portion of incoming magic damage into healing.
13. [Frozen Drops Bonus](./FrozenDropsBonus.md) - Grants bonus loot from kills dealt primarily via cold damage.
14. [Omnetic Bonus](./OmneticBonus.md) - Makes a tool function as an entire toolset.
15. [Radial Bonus](./RadialBonus.md) - Makes a tool mine an area of blocks.
16. [Fortification Bonus](./FortificationBonus.md) - Grants fortification shields when hurt. Requires Twilight Forest.
17. [Ore Magnet Bonus](./OreMagnetBonus.md) - Allows using the tool as an Ore Magnet. Requires Twilight Forest.
18. [Treasure Goblin Bonus](./TreasureGoblinBonus.md) - Chance to summon a Treasure Goblin when attacking. Requires Twilight Forest.
